...
static char doc[] = "Software for recording SpaceWire traffic\v This program records specified SpaceWire Characters for an adjustable amount of time using a STAR-Dundee SpaceWire Link Analyzer Mk3 and decodes the FEE data-packets used in the PLATO project.";
...
static struct argp_option options[] = {
    //{"device",  'd', "SERIAL_NO",   0,  "Connect to LA with this SN" },
    //{"time",    't', "SECONDS",     0,  "Length of recording in seconds" },
